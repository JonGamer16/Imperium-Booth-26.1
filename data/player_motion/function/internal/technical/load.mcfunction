...
scoreboard objectives add player_motion.internal.const dummy
    ...
    scoreboard players set #constant.3 player_motion.internal.const 3
    scoreboard players set #constant.4 player_motion.internal.const 4
    scoreboard players set #constant.5 player_motion.internal.const 5
